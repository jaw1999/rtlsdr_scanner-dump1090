...
from frequency_scanner import FrequencyScannerTab  # Import the new tab
...
class SpectrumAnalyzer(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        ...
        self.frequency_scanner_tab = FrequencyScannerTab(self.sdr_controller)  # New tab
        ...
        self.tabs.addTab(self.frequency_scanner_tab, "Frequency Scanner")  # Add new tab
    ...
    def on_dump1090_started(self):
        # Stop any ongoing SDR scan in HomeTab, SignalAnalysisTab, and FrequencyScannerTab
