...
from signal_analysis_tab import SignalAnalysisTab  # Import the new tab
...
class SpectrumAnalyzer(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        ...
        self.signal_analysis_tab = SignalAnalysisTab(self.sdr_controller)  # New tab

        self.tabs.addTab(self.dump1090_tab, "Dump1090")
        self.tabs.addTab(self.home_tab, "Home")
        self.tabs.addTab(self.signal_analysis_tab, "Signal Analysis")  # Add new tab
    ...
    def on_dump1090_started(self):
        # Stop any ongoing SDR scan in HomeTab and SignalAnalysisTab
